	...
	if (cartList.length > 0){
		for (var i=0; i<column; i++) {
			switch (i)
			{
				...
				break;
				case 1:
					x[i].innerHTML = 'SKU Code';
				break;
				case 2:
					x[i].innerHTML = 'Product Name';
				break;
				case 3:
					x[i].innerHTML = 'Serial Number';
				break;
				case 4:
					x[i].innerHTML = 'Total Qty';
					x[i].align = "center";
				break;
				case 5:
					x[i].innerHTML = 'Total FOC';
					x[i].align = "center";
				break;
				case 6:
...
function addToCart(no, idx) {
	...
	var serial = document.getElementById('serial_'+ProductList[idx].ct +'_'+ProductList[idx].id);
	...
	for (var i=0; i<column; i++) {
		...
		switch (i)
		{
			...
			break;
			case 3:
				data[i].innerHTML = serial.innerHTML;
			break;
			case 4:
