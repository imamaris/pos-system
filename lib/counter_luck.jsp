...
function calcGrandTotal() {
	...
	if (thisform.TotalBV != null)
		TotalBV.innerText = bv == 0 ? "0" : formatAmount(bv);
	        Lucky.innerText = luck == 0 ? "0" : decFormat1(luck);
...
function decFormat1(amount) {
	var i = Math.ceil(amount*(-1));
        i = Math.abs(i);
        var out = formatNumber(i, 0, ',', '' , '' , '' , '-' , '');
	return out;
}
