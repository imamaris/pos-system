...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_UDPATE_COUNTRY_SUBMIT,request)%>" method="post">
<input type="hidden" name="parentid" value="HQ">
<input type="hidden" name="locid" value="<%=bean.getLocationID()%>">

<div class="functionhead"><i18n:label code="ADMIN_COUNTRY_UPDATE"/></div>
<br>
