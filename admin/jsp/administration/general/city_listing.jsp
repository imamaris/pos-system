...
<head>
	...
	<body>
	<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.CITY_LISTING%>"/></div><br>

	
	<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_CITY_LISTING,request)%>" method="post">
	...
	<table class="listbox" width="75%">
		  ...
		  %>
			   <tr class="<%=rowCss%>" valign=top>
					...
					<td align=center><small><std:link text="edit" taskid="<%=LocationManager.TASKID_UDPATE_CITY%>" params="<%=("locid="+beans[i].getLocationID())%>" /></small></td>
