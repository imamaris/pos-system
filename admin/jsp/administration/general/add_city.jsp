...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_ADD_NEW_CITY,request)%>" method="post">

<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.ADD_CITY%>"/></div>
<br>
	
<table width=500>
	<tr>
	 	<td class="td1" width="180"><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.PARENT%>"/>:</td>
	 	<td>
	 ...
	 <tr>
	 	<td class="td1" width="200"><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.LOCATION_ID%>"/> (2-5 chars):</td>
