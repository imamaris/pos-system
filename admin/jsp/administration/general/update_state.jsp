...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_UDPATE_STATE_SUBMIT,request)%>" method="post">
<input type="hidden" name="locid" value="<%=bean.getLocationID()%>">

<div class="functionhead"><i18n:label code="ADMIN_STATE_UPDATE"/></div>
<br>
