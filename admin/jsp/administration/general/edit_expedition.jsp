...
<div class="functionhead">Edit Expedition</div>

<form name="frmSupplierEdit" action="<%=Sys.getControllerURL(ExpeditionManager.TASKID_EXPEDITION_EDIT_FORM,request)%>" method="post">
		...
		<tr>
			<td>
				<table class="tbldata" width="100%">
				  	<tr>
						<td colspan="2" class="sectionhead">Expedition Details</td>
			  	  	</tr>
				  	<tr>
