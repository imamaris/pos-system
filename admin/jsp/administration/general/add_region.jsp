...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_ADD_NEW_REGION,request)%>" method="post">

<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.ADD_REGION%>"/></div>
<br>
