...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_UDPATE_CITY_SUBMIT,request)%>" method="post">
<input type="hidden" name="locid" value="<%=bean.getLocationID()%>">

<div class="functionhead"><i18n:label code="ADMIN_CITY_UPDATE"/></div>
<br>
