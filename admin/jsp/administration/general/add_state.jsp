...
<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_ADD_NEW_STATE,request)%>" method="post">

<div class="functionhead">
<i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.ADD_STATE%>"/></div>
<br>
