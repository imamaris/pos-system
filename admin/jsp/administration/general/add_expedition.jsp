...
<div class="functionhead">Create New Expedition</div>

<form name="frmSupplierRegister" action="<%=Sys.getControllerURL(ExpeditionManager.TASKID_EXPEDITION_REG_FORM,request)%>" method="post">
		...
		<tr>
			<td>
				<table class="tbldata" width="100%">
				  	<tr>
						<td colspan="2" class="sectionhead">Expeditionn Details</td>
			  	  	</tr>
				  	<tr>
