...
<head>
	...
	<body>
	<div class=functionhead><i18n:label localeRef="mylocale" code="<%=GeographicMessageTag.STATE_LISTING%>"/></div><br>

<form name="add" action="<%=Sys.getControllerURL(LocationManager.TASKID_STATE_LISTING,request)%>" method="post">
	...
	<table class="listbox" width="75%">
		  ...
		  %>
			   <tr class="<%=((i%2==1)?"odd":"even")%>" >
					...
					<td align=center><small><std:link text="edit" taskid="<%=LocationManager.TASKID_UDPATE_STATE%>" params="<%=("locid="+beans[i].getLocationID())%>" /></small></td>
