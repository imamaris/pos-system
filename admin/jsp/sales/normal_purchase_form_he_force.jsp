	...
	document.getElementById("iprice_"+i).value ="";	
	 ...
	 else if(strar.length>1)
	 {
		...
		document.getElementById("ibrand_"+i).value= strar[4];
                ...
                document.getElementById("ipricerp_"+i).value= strar[12]; //Updated By Ferdi 2015-06-18
                document.getElementById("iserial_"+i).value= strar[6];
                document.getElementById("icode_"+i).value= strar[11];                           
                document.getElementById("irate_"+i).value= strar[13];
                document.getElementById("irateCcy_"+i).value= strar[14];
...
<div class="functionhead"> <font color="red"> Sales Entry (Force) </font> </div>
...
<table class="tbldata" border="0" width="900">
    ...
    <tr>
        ...
        <td width="150"><%= bean.getSellerID() %> </td>         
        <td>&nbsp;</td>
...
<a name="self"></a>
            ...
            <table class="listbox" width="800">
                ...
                <tr class="boxhead" valign="top" >
                    ...
                    <td align="center" nowrap><i18n:label code="PRODUCT_UNIT_PRICE"/> (IDR)</td> <!-- Updated By Ferdi 2015-06-17 -->
                ...
                <tr>
                    ...
                    <td valign="top">    
                        ...
                        <table width="200">    
                            ...
                            <!--                                
                             <input type="text" id="Grandtotal" value="" disabled></LABEL></td>
                            -->
                             </tr>
...
<table width="80%" border="0">   
                ...
                <tr>		                   
                    ...
                    </td> --> <!-- Updated By Ferdi 2015-06-17 -->
                    <!-- End Updated -->
