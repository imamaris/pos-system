...
<%@ page import="com.ecosmosis.orca.warranty.*"%>
...
<br>
    ...
    <table class="tbldatabaru" border="0" width="600">                
	  ...
	  <td colspan=2 align=center width="450"><hr></td>
        ...
        <tr valign="top">
		<td valign=top>
			<%@ include file="/admin/jsp/sales/view_sales_document_ereceipt.jsp"%>
		</td>
	</tr>
	...
	<tr valign=top>
		<td colspan="2" width="450">
		  <%@ include file="/admin/jsp/sales/view_sales_cart_he_ereceipt.jsp"%>                  
		</td>
	</tr>
		...
		<td valign=top width="500">
			<%@ include file="/admin/jsp/sales/view_sales_customer_ereceipt.jsp"%>
		</td>
	</tr>        
