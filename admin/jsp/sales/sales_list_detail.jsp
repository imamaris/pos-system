...
<html>
    ...
    <body>
        ...
        <div class="functionhead"><i18n:label code="Sales Listing Detail"/></div>
        
        <form name="frmSearch" action="<%=Sys.getControllerURL(CounterSalesManager.TASKID_SALES_LIST_DETAIL,request)%>" method="post" onSubmit="return doSubmit(document.frmSearch);">
            <table border="0">
                <tr>
        ...
        <form name="frmList" action="" method="post">
            ...
            <table class="listbox" width="100%">
                <tr class="boxhead" valign=top>
                    ...
                    <td width="10%"><i18n:label code="SALES_TRX_DATE"/></td>
                    <td width="15%"><i18n:label code="SALES_REFERENCE"/></td>
                    ...
                    <td align="center" nowrap>Net Sales</td>
                ...
                <tr class="boxhead" valign=top>
                    <td align="center" nowrap colspan="4" >Total : </td>
                ...
                <tr class="<%= rowCss %>" valign=top>
                    ...
                    <td nowrap>
                        <std:text value="<%= beans[i].getTrxDocNo() %>" />
                        </td>
                    <td nowrap>
                    ...
                    <td align="center" nowrap><std:text value="<%= beans[i].getProductCode() %>" defaultvalue="-"/></td>
                    <td align="left" nowrap><std:text value="<%= beans[i].getDefaultName() %>" defaultvalue="-"/></td>
                    <td align="right" nowrap><std:currencyformater code="" value="<%= beans[i].getPrice() %>"/></td>
                    <td align="right" nowrap><std:bvformater value="<%= beans[i].getQtySale() %>"/></td>
                    <td align="right" nowrap><std:currencyformater code="" value="<%= beans[i].getPriceSale() %>"/></td>
                    <td align="right" nowrap><std:currencyformater code="" value="<%= beans[i].getPriceSale()* beans[i].getDiscountRate() * 0.01D %>"/></td>
                    <td align="right" nowrap><std:currencyformater code="" value="<%= beans[i].getPriceSale() - (beans[i].getPriceSale()* beans[i].getDiscountRate() * 0.01D) %>"/></td>
                </tr>
