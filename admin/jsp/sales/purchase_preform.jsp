...
// SalesmanBean sales = (SalesmanBean) returnBean.getReturnObject("SalesmanBean");
...
<form name="frmSalesOrder" action="<%=Sys.getControllerURL(taskID,request)%>" method="post" onSubmit="return doSubmit(document.frmSalesOrder);">
    ...
    <table class="tbldata">
        ...
        <td colspan="2">
            ...
            <td >
                <input type="text" name="NmCust" id="NmCust" value=""  onblur="IsName();" size="25" maxlength="25">
                <std:input type="hidden" name="CustomerName" />
            </td>   
            
            <td>
                <input type="hidden" name="IdCust" id="IdCust" value="" size="25" maxlength="25" disabled>
        ...
        <tr>
            ...
            <td align="left"><std:input type="select" name="Salesman" options="<%= staffMap %>" value="<%=request.getParameter("Salesman") %>" /></td>
	</tr>        
