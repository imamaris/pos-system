...
<form name="frmSearch" action="<%=Sys.getControllerURL(CounterSalesManager.TASKID_SALES_LIST_INVOICE_RETURN,request)%>" method="post" onSubmit="return doSubmit(document.frmSearch);">
	  ...
	  <tr>
	    ...
	    <td><std:input type="text" name="TrxDocNo" size="30"  value="JKT1-CB00000018" maxlength="20"/></td>
	    <td>&nbsp;</td>
	    <td class="td1"></td>
	    <td></td>
	  </tr>
...
<form name="frmList" action="" method="post">
            ...
            <table class="listbox" width="80%">
                ...
                <tr class="<%= rowCss %>" valign=top>
                    ...
                    <td align="center">
                        <small><std:link text="<%=("<li>" + lang.display("Process"))%>" taskid="<%= CounterSalesManager.TASKID_REFUND_SALES_INVOICE %>" params="<%=("SalesID="+beans[i].getSalesID())%>" /></small>
                    </td>
