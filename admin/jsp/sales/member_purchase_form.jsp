    ...
    <body onLoad="self.focus(); init();">
        ...
        <form name="frmSalesOrder" action="" method="post">
                ...
                <div id="sc<%= x+1 %>" class="tabcontent">
                    ...
                    <table class="listbox" width="800">
                        ...
                        <tr>		
                            ...
                            <td align="right" ID="stock_<%= itemBeans[i].getCatID() %>_<%= itemBeans[i].getProductID() %>">
                                <b><%= stockBalance %></b>
                            </td>                
                            <td align=center>
            ...
            <table border="0" width="700" border="0">
                <tr align="right">
                    <td width="500" style="left"><b><i18n:label code="GENERAL_TOTAL"/> PV:</b>&nbsp;&nbsp;<LABEL ID="TotalBV">0</LABEL>&nbsp;&nbsp;</td>
                    <td colspan="5" >&nbsp;&nbsp;</td>
