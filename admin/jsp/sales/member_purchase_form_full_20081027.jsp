...
%>
	...
	<tr>		
		...
		<td align=center>
			<std:input type="text" name="<%= "Qty_" + itemBeans[i].getCatID() + "_" + itemBeans[i].getProductID() %>" status="<%= "style=text-align:right "  + ("onKeyUp='calcUnit("+ itemId + ", this); Cart("+ itemId+")';") %>" size="4" maxlength="4"/>                        
		</td>
		<td align=center>
