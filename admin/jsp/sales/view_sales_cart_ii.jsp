...
<%
	...
	for (int i = 0; i < itemSales.length; i++) {
		...
		double unitType = counter.getTypeUnit(product.getSkuCode(), itemSales[i].getUnitPrice(), itemSales[i].getBv1(), 2);
		gross += (qtyOrder * unitType);
%>
...
%>
	...
	<tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="GENERAL_GROSS"/>:</b>
		<td class="td1"><std:currencyformater code="" value="<%= gross %>"/></td>
	</tr>
	<tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="SALES_DELIVERY_AMOUNT"/>:</b>
		<td class="td1"><std:currencyformater code="" value="<%= bean.getDeliveryAmount() %>"/></td>
	</tr>
	<tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="SALES_DISCOUNT_AMOUNT"/>:</b>
	...
	%>	
	<tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="SALES_MGMT_FEE"/>:</b>
	...
	<tr>
		...
		<td class="td1"><b><std:currencyformater code="" value="<%= (bean.getChiSalesAmount()) %>"/></b></td>
	</tr>
	<!-- tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="SALES_PAYMENT_RECEIVED"/>:</b>
		<td class="td1"><std:currencyformater code="" value="<%= bean.getPaymentTender() %>"/></td>
	</tr>
	<tr>
		<td class="td1 totalhead" colspan="6"><b><i18n:label code="SALES_CHANGE_DUE"/>:</b>
