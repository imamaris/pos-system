...
<div class="functionhead">Sales Re-Print</div>

<form name="frmSearch" action="<%=Sys.getControllerURL(CounterSalesManager.TASKID_SALES_LIST_REPRINT,request)%>" method="post" onSubmit="return doSubmit(document.frmSearch);">
