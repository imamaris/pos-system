...
<script language="javascript">
  <!--	  
	...
	var selectedFocUnit = 0;
		...
		// tambahan paket 1100
                // var grdBV = replacePriceValue(TotalBV.innerText);
		// grdBV = grdBV * 1;

		// if (grdTotal > 0) {
                //        if (bean.getCustomerReg() == 7 && grdBV < 1100) {
		//		alert("<i18n:label code="Total PV is Less 1100"/>");
		//		return;
		//	}
		// }	else 
...
<table class="tbldata" border="0" width="500">
	...
	<tr>
		<td class="td1" width="130"><i18n:label code="GENERAL_ID"/>:</td>
	...
	<tr>
        ...
        <tr>
                <%
                if (bean.getCustomerReg() == 7) {
                %>
		<td class="td1" ><span class="required note">*<i18n:label code="Paket Register "/>:</span></td>
		<td> <span class="required note">1100 PV </span></td>
                <%
                }
                %>
        </tr>         
	...
	<tr>
		...
		<td><std:text value="<%= bean.getBonusPeriodID() %>"/></td>
	</tr>
	<tr>
