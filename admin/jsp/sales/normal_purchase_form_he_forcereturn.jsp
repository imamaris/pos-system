...
if(document.getElementById("icode_"+i).value!="-1")
{
    ...
    var url="NoUseHeForceReturn.jsp";   
...
<div class="functionhead"> <font color="red"> Sales Return (Force) </font> </div>
...
<a name="self"></a>
            ...
            <table class="listbox" width="800">
                ...
                <tr >
                    ...
                    <td align=center>
                        <std:input type="text" name="<%= "Qty_" + i %>" status="<%= "style=text-align:right "  + ("onKeyUp='calcUnitForceReturn("+ i + ", this)';") %>" size="4" maxlength="4"/>             
                    </td>
