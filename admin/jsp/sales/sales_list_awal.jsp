...
<table class="listbox" width="100%">
  <tr class="boxhead" valign=top>
    ...
    <td><i18n:label code="DELIVERY_STATUS"/></td>
    <td><i18n:label code="GENERAL_STATUS"/></td>
    <td><i18n:label code="SALES_VOID"/></td>
    <td><i18n:label code="SALES_REFUND"/></td>
  </tr>
  ...
  %>
    ...
    <td align="center">
    	<small><std:link text="<%=("<li>" + lang.display("SALES_REFUND"))%>" taskid="<%= CounterSalesManager.TASKID_REFUND_SALES %>" params="<%=("SalesID="+beans[i].getSalesID())%>" /></small>
    </td>
