        ...
        <form name="frmSalesOrder" action="" method="post">
            ...
            <table class="listbox" width="80%">
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" name="icode_<%= i%>" id="icode_<%= i%>" value="" onKeyUp="showEmp(<%= i%>, '<%= Sys.getDateFormater().format(bean.getBonusDate()) %>', '<%= bean.getSellerID() %>', this.value);" onblur="showKit2(<%= i%>, '<%= Sys.getDateFormater().format(bean.getBonusDate()) %>', '<%= bean.getSellerID() %>', this.value);" size="10" maxlength="30"> 
