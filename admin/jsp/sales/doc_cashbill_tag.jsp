...
// String alamat = bean.getBonusEarnerName()
...
<table class="tbldatabaru" border="0" width="500">                
    
    <tr valign=top>
        <td colspan=2 align="center"> <font size="4" style="bold" color="white"></font></td>
    </tr>  
    
    <tr valign=top >
        <td colspan=4 align="center"> <font size="4" style="bold"> INVOICE </font></td>
    </tr>        
