<table class="listbox">
	...
	<tr class="boxhead" valign="top">
		...
		<td nowrap>Description</td>
                <td nowrap>Series</td>
                <td nowrap align="center"><i18n:label code="GENERAL_QTY"/></td>
                <td nowrap align="center">Gross </td>
                <td nowrap align="center">Disc (%) </td>
                <td nowrap align="center">Disc (Rp)</td>                
		<td nowrap align="center">Charge (<%= bean.getLocalCurrencySymbol() %>)</td>
	</tr>
...
%>
	...
	<tr class="<%= ((i+1) % 2 == 0) ? "even" : "odd" %>" valign=top>
		...
		<td><%= product.getProductDescription().getName() %> </td>
                ...
                <td align="center" nowrap><%= qtyOrder %></td>
