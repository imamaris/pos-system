...
{ 
	...
	document.getElementById("iprice_"+i).value ="";	 
        ...
        // document.getElementById("ipaket_"+i).value ="";	
        
        document.getElementById("ikit_"+i).value= "";
	...
	document.getElementById("iprice_"+i).value ="";	
	 ...
	 else if(strar.length>1)
	 {
		...
		document.getElementById("ibrand_"+i).value= strar[4];
                ...
                // document.getElementById("ipaket_"+i).value = strar[11];	
                
                document.getElementById("ikit_"+i).value= strar[11];
...
function showKit(i, tanggal, lokasi, sku_kode)
{ 

if(document.getElementById("ikit_"+i).value!="-1")

{
 ...
 xmlHttpKit.onreadystatechange=function() {
    if (xmlHttpKit.readyState==4) {
        // alert(tanggal);
      stateChangedKit(i, tanggal, lokasi, xmlHttpKit.responseText);      
    }
  };
...
function stateChangedKit(i, tanggal, lokasi, text) 
{ 
        // alert(tanggal);       
	document.getElementById("irefkit_"+i).value ="";
	document.getElementById("inamekit_"+i).value ="";
	document.getElementById("iserialkit_"+i).value ="";
	document.getElementById("inameitemkit_"+i).value ="";	         
        document.getElementById("ijumkit_"+i).value ="";	 
...
if (xmlHttpKit.readyState==4 || xmlHttpKit.readyState=="complete")
 { 
  ...
  var strarkit = showdatakit.split("~");
	 ...
	 if(strarkit.length==1)
	 {
         
         // alert ("a");
        // document.getElementById("ikit_"+i).focus(); 
	...
	document.getElementById("inameitemkit_"+i).value ="";	         
	 ...
	 else if(strarkit.length>1)
	 {
		var strname = strarkit[1];
        
        document.getElementById("ikit_"+i).value= strarkit[6];
        
	document.getElementById("irefkit_"+i).value = strarkit[1];
	document.getElementById("inamekit_"+i).value = strarkit[2];
	document.getElementById("iserialkit_"+i).value = strarkit[3];
	document.getElementById("inameitemkit_"+i).value = strarkit[4];
        document.getElementById("ijumkit_"+i).value = strarkit[5];               
        ...
        <form name="frmSalesOrder" action="" method="post">
            ...
            <table class="listbox" width="800">
                ...
                <tr class="boxhead" valign="top" >
                    ...
                    <td align="center" >Net Price<br>(<%= bean.getLocalCurrency() %>)</td>
                    <td align="center" nowrap>Sales ID</td>
                    <td align="center" nowrap>Stock</td>
                    <td align="center" nowrap>KIT</td>
                ...
                <tr >
                    ...
                    <td align=center>                        
                         <input type="text"  name="ikit_<%= i%>" id="ikit_<%= i%>" value="" onkeyup="showKit(<%= i%>, '<%= Sys.getDateFormater().format(bean.getBonusDate()) %>', '<%= bean.getSellerID() %>', this.value);" size="10" maxlength="20"  > 
                         <input type="hidden" name="kit_<%= i%>"  id="kit_<%= i%>" value="ikit_<%= i%>" >   
                    </td>                    
                </tr> 
            ...
            <table width="800">
                ...
                <td valign="top">    
                    <table class="listbox"  width="500">
                        ...
                        <tr class="boxhead" valign="top" >
                            <td nowrap >KIT Ref. Number</td>
                            <td nowrap >KIT Description</td>
                            <td nowrap >Reference Number</td>
                            <td nowrap >Reference Description</td>
                        ...
                        for(int j=1;j< ulangkit ; j++) {    
                        %>
                        
                        <tr >  
                            
                            <td > 
                                <input  type="text" class="boxcontent" name="irefkit_<%= j%>" id="irefkit_<%= j%>" value="" disabled >
                                    <input type="hidden" name="refkit_<%= j%>" id="refkit_<%= j%>" value="irefkit_<%= j%>" > 
                            </td>
                            <td > 
                                <input type="text" class="boxcontent" name="inamekit_<%= j%>" id="inamekit_<%= j%>" value="" disabled >
                                    <input type="hidden" name="namekit_<%= j%>"  id="namekit_<%= j%>" value="inamekit_<%= j%>" > 
                            </td>  
                            <td > 
                                <input  type="text" class="boxcontent" name="iserialkit_<%= j%>" id="iserialkit_<%= j%>" value="" disabled >
                                    <input type="hidden" name="serialkit_<%= j%>" id="serialkit_<%= j%>" value="iserialkit_<%= j%>" > 
                            </td>
                            <td > 
                                <input type="text" class="boxcontent" name="inameitemkit_<%= j%>" id="inameitemkit_<%= j%>" value="" disabled >
                                <input type="hidden" name="nameitemkit_<%= j%>"  id="nameitemkit_<%= j%>" value="inameitemkit_<%= j%>" > 
                            </td>                                            
                            <td width="2" align="center"> 
                                <input type="text" align="center" class="boxcontent" name="ijumkit_<%= j%>" id="ijumkit_<%= j%>" value="" disabled size="4" >
                                <input type="hidden" name="jumkit_<%= j%>"  id="jumkit_<%= j%>" value="ijumkit_<%= j%>" >                                 
                            </td> 
                        </tr> 
                ...
                <td valign="top">    
                    ...
                    <table width="300">    
                        ...
                        <tr align="right" >
                            ...
                            <td align="right" nowrap><LABEL ID="Grandtotal"> <input type="text" id="Grandtotal" value="" disabled></LABEL></td>
                        </tr>
