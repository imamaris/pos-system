...
function calcMiscAmount3(obj) {
	obj.value = decFormat(obj.value * 1);
        var voucher = obj.value;
        // alert ("sini dulu "+voucher);
	calcGrandTotal2(voucher);
}      
function calcGrandTotal2() {
	...
	*/
	...
	orderPayment = total == 0 ? total : (total - discount);
        alert("order payment " + orderPayment);
...
function valDate(obj){
  ...
  //-->
        //Updated By Ferdi 2015-01-26
        function checkDepositAmount(deposit){
        
            var total = parseInt(decFormat(replaceValueWithCommas($("#Total").html())));
            
            if(total < deposit) deposit = total;
            
            var grandtotal = total - deposit;
            
            $("input[name=DeliveryAmount]").val(deposit);
            $("#DepositAmt").html(formatAmount(deposit));
            $("#Grandtotal").html(formatAmount(grandtotal));
        ...
        <form name="frmSalesOrder" action="" method="post">
            ...
            <table class="tbldata" border="0" width="800">                
                ...
                <tr>
                    ...
                    <input type="hidden" name="irate" value="1" size="6"/>  
                    ...
                    <td valign="top">    
                        <table class="listbox"  width="300">
                            ...
                            <tr>  
                                ...
                                <input type="text" name="Amt_<%= j%>"  value="0" >  
                    ...
                    <td valign="top">  
                        <table width="200">    
                            ...
                            <tr align=right>
                                ...
                                <td><label id="DepositAmt"><std:currencyformater code="" value="<%= Double.parseDouble(bean.getCustomerRemark()) %>"/></label></td>    
                            ...
                            <tr align=right>
                                ...
                                <td>
                                    <input align="right" type="text" id="valCard4" name="card_4" value="" readonly />                        
                                </td>         
                                <td >
                                    <input type="button" value="Swipe" onClick="externalPaymentPopup(4, '<%= Sys.getDateFormater().format(bean.getBonusDate()) %>', '<%= bean.getSellerID() %>', 'A');" /> 
                                </td>
                            </tr>
                            ...
                            <tr align=right>
                                ...
                                <td align="right">                              
                                    <input align="right" type="text" id="amount_4" name="DiscountAmount" readonly onblur="calcMiscAmount3(this);"  />                         
                                </td>                                                     
                                <td></td>                    
                            </tr>                 
