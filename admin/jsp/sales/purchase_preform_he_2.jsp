...
<form name="frmSalesOrder" action="<%=Sys.getControllerURL(taskID,request)%>" method="post" onSubmit="return doSubmit(document.frmSalesOrder);">
    ...
    <table class="tbldata">
        ...
        <tr>
            ...
            <td class="td1">Previllage Card :</td>
            ...
            <td>
                ...
                <div id='menuC' style="display: none;">
                    <table >
                        <tr>
                            <td align="left">  
                                <input type="password" name="icode3" id="icode3" value="<%= custContact %>" onblur="showEmp(<%= 1%>, this.value);" size="4" maxlength="4"> 
                            </td>  
                        </tr>
                    </table>
                </div>
        ...
        <tr>
            ...
            <td colspan="2"><std:input type="date" name="BonusDate" value="<%= Sys.getDateFormater().format(new Date()) %>"/> yyyy-mm-dd</td>
                ...
                <div id='menuN' style="display: visible;">                   
                    <table >
                        <tr>
                            <td width="40%"></td>
                            <td align="left">
                                <input type="text" name="icode2" id="icode2" value="<%= custContact %>" onblur="showEmp(<%= 1%>, this.value);" size="25" maxlength="15">             
                            </td>                                                                
                        </tr>
                    </table>
                </div>
