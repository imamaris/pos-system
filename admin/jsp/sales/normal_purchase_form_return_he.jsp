...
<script language="javascript">
	...
	function doSubmit(thisform) {
	    ...
	    thisform.diskonvoucher.value = thisform.DiscountAmount.value;
            //brand = document.getElementById("ibrand_1").value;
            //diskonvoucher = document.getElementById("DiscountAmount").value;
...
<body onLoad="self.focus();">
    ...
    <table class="tbldata" border="0" width="800">          
        <tr>
            ...
            <td> <std:text value="<%= bean.getBonusEarnerID() %>" /><input type="hidden" name="isales" value="<%= bean.getBonusEarnerID() %>"/></td>                     
        </tr>  
        <tr>
        ...
        <tr>
            ...
            <td width="100"></td>
            <td >&nbsp;</td>      
            <td class="td1" width="100">Document Date :</td>
            <td width="100"><fmt:formatDate pattern="<%= loginUser.getDateformat() %>" value="<%= bean.getBonusDate() %>" /></td>                    
    ...
    <table class="listbox" width="80%">
        ...
        <tr>
            ...
            <td align=center>
                <std:input type="text" name="<%= "Qty_" + i %>" status="<%= "style=text-align:right "  + ("onKeyUp='calcUnitSIR("+ i + ", this)';") %>" size="4" maxlength="4"/>
            </td>
            <td align=center>
                <std:input type="text" name="<%= "Foc_" + i %>" status="<%= "style=text-align:right " + ("onblur='calcUnitFocSIR("+ i + ", this)';") %>" size="10" maxlength="10"/>
            </td>                    
            <td> 
                <std:input type="text" name="<%= "Disc_" + i %>" status="<%= "style=text-align:right " + ("onKeyUp='calcUnitFoc2SIR("+ i + ", this)';") %>" size="10" maxlength="10"/>
            </td>                                              
            <td>                        
                <std:input type="text" name="<%= "Amt_" + i %>" status="<%= "style=text-align:right " + ("onKeyUp='calcUnitFoc3SIR("+ i + ", this)';") %>" size="15" maxlength="15"/>
    ...
    <tr>
        ...
        <td valign="top">  
            <table width="200">    
                <tr align="right">
                    <td>&nbsp;</td>
                    <td colspan="8"><b><i18n:label code="GENERAL_GROSS"/> :</b></td>
                    <td colspan="3"><LABEL ID="Total">0.00</LABEL></td>                                
                </tr>                           
                <tr align=right>
                    <td>&nbsp;</td>
                    <td colspan="8"><b>Deposit Amt :</b></td>                       
                    <td colspan="3"><label id="DepositAmt"><std:currencyformater code="" value="<%= Double.parseDouble(bean.getCustomerRemark()) %>"/></label></td>    
                    <std:input type="hidden" name="DeliveryAmount" value="<%= bean.getCustomerRemark()%>"/>                                                   
                </tr>
                <tr align="right">
                    <td>&nbsp;</td>
                    <td colspan="8"><b>Balance :</b></td>
                    <td colspan="3"><LABEL ID="addFee">0.00</LABEL></td>
                </tr><!--
                <tr>
                    <td colspan="9">&nbsp;</td>
                    <td colspan="2" align="right"><input type="checkbox" style="border:0" name="refund" id="check"><b>Refund</b></td>                    
                </tr>-->
                ...
                <tr align=right>
                    ...
                    <td colspan="3"><LABEL ID="Grandtotal"> <input type="text" id="Grandtotal" size="10" value="" disabled></LABEL></td>                                
                </tr>
            </table>
        </td>                                
    </tr>
