...
<table border="0">
        ...
        <tr class=baru valign=top>
            <td colspan="3" valign="top" align="left" width="600"><std:text value="<%= bean.getCustomerID() %>"/></TD>
        ...
        <tr class=baru valign=top>
            <td colspan="3" valign="top" align="left"  ><std:text value="<%= bean.getCustomerContact() != null ? bean.getCustomerContact().replaceAll("\n", "<br>") : "-" %>"/></TD>
            <td colspan="2" valign="top" align="RIGHT"  > </TD>               
        </TR>
        ...
        <tr class=baru valign=top>		
		<td colspan="2" valign="top" align="left"  ><std:text value="<%= bean.getCustomerIdentityNo() %>"/></TD>
                <td colspan="3" valign="top" align="center"  ><u><std:text value="<%= bean.getCustomerName() %>"/></u></TD>               
	</tr>
