                ...
                <tr>		                   
                    <td class="td1" width="130">
                        <select name="paymode_<%=i%>">
                            ...
                            <option value="<%= paymode.getDefaultDesc() %>><%= paymode.getPaymodeCode()%>><%= paymode.getOutletEdc()%>><%= paymode.getOutletTime()%>><%= paymode.getGroup()%>" <%= m==i? "selected":"" %>><%= paymode.getDefaultDesc() %> - <%= paymode.getOutletEdc()%> - <%= paymode.getOutletTime()%> </option>
