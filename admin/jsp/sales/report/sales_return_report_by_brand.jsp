...
<%
  MvcReturnBean returnBean = (MvcReturnBean)  request.getAttribute(MvcReturnBean.RETURNBEANCODE);
	...
	ArrayList confirmBonusPeriodList = (ArrayList) returnBean.getReturnObject(CounterSalesManager.RETURN_CFIMBNSPERIODLIST_CODE);
        ...
        CounterSalesItemBean[] beans = (CounterSalesItemBean[]) returnBean.getReturnObject(CounterSalesManager.RETURN_SUMMARY_SALES_RETURN_BRAND);
        
        CounterSalesOrderBean[] bean = (CounterSalesOrderBean[]) returnBean.getReturnObject(CounterSalesManager.RETURN_SUMMARY_SALES_RETURN_BRAND_DETAIL);
...
<div class="functionhead"><i18n:label code="SALES RETURN REPORT BY BRAND"/></div>

<form name="frmSearch" action="<%=Sys.getControllerURL(CounterSalesManager.RETURN_SUMMARY_SALES_RETURN_REPORT_ID,request)%>" method="post" onSubmit="return doSubmit(document.frmSearch);">
...
<table class="outerbox" width="80%">
   <tr class="boxhead" valign="top">
        <td>
        <b><i18n:label code="SUMMARY SALES RETURN REPORT"/><br /> 
        <% 
   ...
   <% if(selection.equals("1")){ %>
    <%@ include file="/admin/jsp/sales/report/summary_sales_return_report_by_brand.jsp" %>
    <% }else { %>
    <tr>
