                            ...
                            <td>
                                <table class="listbox">
                                    <tr class="boxhead" valign="top">
                                        ...
                                        <td><i18n:label code="GENERAL_CREATEDBY"/></td>
                                    </tr>
                                    ...
                                    <tr class="<%= rowCss %>" valign="top">
                                        ...
                                        <td nowrap ><%=  bean.getShipRemark() != null &&  bean.getShipRemark().length() > 0 ?  bean.getShipRemark().replaceAll("\n","<br>") : "-" %> </td> 
                                        ...
                                        <td align="right" nowrap> <%= df.format((bean.getTotalBv3()/(bean.getNetSalesAmount() + bean.getTotalBv3()))*100 ) %> </td>  
                                        
                                        <td align="right" nowrap><std:currencyformater code="" value="<%= bean.getNetSalesAmount() %>"/></td>
  
	  <td nowrap>
	  	<std:text value="<%= bean.getBonusEarnerID().trim().concat(" - ").concat(bean.getBonusEarnerName()).trim() %>"/>
	  </td>
                                        
                                        	  <td nowrap>
	  	<std:text value="<%= bean.getCustomerID().trim().concat(" - ").concat(bean.getCustomerName()).trim() %>"/>
	  </td>
