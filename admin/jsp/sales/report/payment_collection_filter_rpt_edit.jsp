    ...
    <body>
        ...
        <table>
            ...
            <tr>
                            ...
                            <td>
                                <table class="listbox" width="500">
                                    ...
                                    <tr class="totalhead" valign="top">
                                        <td width="150" nowrap align="center">Payment Type</td>
                                        <td nowrap align="center">Rate</td>
                                        <td nowrap align="center">Qty</td>                                        
               ...
               // CounterCollectionReportBean.PaymentOrderBean payBean = trxBean.getPayGrpDetail( paymodeList[y].getPaymodeCode().concat(paymodeList[y].getPaymodeEdc()).concat(paymodeList[y].getPaymodeTime()).concat(paymodeList[y].getCurrency() ) ) ;
                
               CounterCollectionReportBean.PaymentOrderBean payBean = trxBean.getPayGrpDetail( paymodeList[y].getPaymodeCode()) ;
               // CounterCollectionReportBean.PaymentOrderBean payBean = trxBean.getPayGrpDetail2( paymodeList[y].getPaymodeCode()) ;
               ...
               if (payBean != null) {
                    totalPayment += (payBean.getPaymentIn() - payBean.getPaymentOut());
                                    ...
                                    <tr class="<%= rowCss %>" valign="top">
                                        <td width="300">
                                            <%= paymodeList[y].getPaymodeDesc()%> - <%= paymodeList[y].getPaymodeEdc() %> - <%= paymodeList[y].getPaymodeTime() %> - <%= paymodeList[y].getCurrency() %>			
                                        </td>
								...
								-->
                                        ...
                                        <td class="td1">
                                            <std:currencyformater code="" value="<%= (payBean != null) ? (payBean.getPaymentRate()) : 0 %>"/>
                                        </td>
                                        <td class="td1">
                                            <std:currencyformater code="" value="<%= (payBean != null) ? (payBean.getCurrCount()) : 0 %>"/>
                                        </td>                                        
                            ...
                            <td>
                                <table class="listbox" width="400">
                                    ...
                                    <tr class="totalhead" valign="top">
                                        <td width="200" nowrap align="center">Invoice Type</td>
                                        <td nowrap align="center">Qty</td>                                        
