...
<html>
    ...
    <body>
        ...
        <form name="frmSearch" id="frmSearch" action="<%=Sys.getControllerURL(taskID,request)%>" method="post">
            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        <% 
                        if (taskID == DSRReportManager.TASKID_ADMIN_DSR_SUMMARY) {
                        %>
                ...
                <tr>
                    ...
                    <td><std:input type="hidden" name="DocDateFrom"/></td>
                    <td></td>
                </tr>
            </table>
        ...
        <%
            String exportFileName = "DSRSummary_" + loginUser.getOutletID();
