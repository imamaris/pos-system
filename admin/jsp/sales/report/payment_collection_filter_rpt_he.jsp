            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        ...
                        <% 
                        if (taskID == CounterSalesReportManager.TASKID_ADMIN_COLLECTION_FILTER_RPT_HE) {
                        %>
                    ...
                    totalAmt += bean.getNetSalesAmount();
                                    ...
                                    <tr class="<%= rowCss %>" valign="top">
                                        <td width="250">
                                            ...
                                            <%= (documentList[k].equalsIgnoreCase("CB") ? "SALES INVOICE" : "SALES RETURN") %>
                                        </td>
                ...
                <td>
                    <table class="outerbox" width="80%">
                        ...
                        <tr>
                            ...
                            <td><b><u><%= documentList[j].equalsIgnoreCase("CB") ?  "SALES INVOICE " :  "SALES RETURN " %> : <%= dtlList.size() %></u></b></td>
                            ...
                            <td>
                                <table class="listbox">
                                    <tr class="boxhead" valign="top">
                                        ...
                                        <td nowrap>Payment Amount <br>(IDR) </td>
                                    ...
                                    <tr class="<%= rowCss %>" valign="top">
                                        ...
                                        <td nowrap> <%= (bean.getTrxDocType().equalsIgnoreCase("CB") ? "SALES INVOICE" : "SALES RETURN") %> </td>                                                                                
                                        <td><%=  bean.getShipReceiver() != null &&  bean.getShipReceiver().length() > 0 ?  bean.getShipReceiver().replaceAll("\n","<br>") : "-" %> </td>                                        
                                        <td><%=  bean.getShipRemark() != null &&  bean.getShipRemark().length() > 0 ?  bean.getShipRemark().replaceAll("\n","<br>") : "-" %> </td>                                        
                                        ...
                                        <td align="right"><%=  bean.getShipRegion() != null &&  bean.getShipRegion().length() > 0 ?  bean.getShipRegion().replaceAll("\n","<br>") : "-" %> </td>  
                                        <td align="right"><%=  bean.getShipState() != null &&  bean.getShipState().length() > 0 ?  bean.getShipState().replaceAll("\n","<br>") : "-" %> </td>  
