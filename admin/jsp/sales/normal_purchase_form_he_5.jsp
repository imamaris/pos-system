        ...
        <form name="frmSalesOrder" action="" method="post">
            ...
            <table class="tbldata" border="0" width="800">
                ...
                <tr>
                    ...
                    <td class="td1" width="100">Doc. Date :</td>
                    <td width="100" align="left" ><fmt:formatDate pattern="<%= loginUser.getDateformat() %>" value="<%= bean.getBonusDate() %>" /></td>
                    
                    <input type="hidden" name="tanggal" value="<%= Sys.getDateFormater().format(bean.getBonusDate()) %>" />                 

                    
                    <td >&nbsp;</td>      
                    <td align="right"> SGD - IDR Rate :</td>                     
            ...
            <table width="800">
                ...
                <tr align=right>
                    <td colspan="8"><b>Voucher Discount :</b></td>
