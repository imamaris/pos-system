...
<div class=functionhead>Lucky Draw's Engine > Input Cash Bill</div>
...
<table>
    ...
    <tr>
        <td align=right><i18n:label code="Cash Bill"/> : </td>
        <td align=left><std:input type="text" name="SalesID" size="15" value="" /></td>        
    </tr>    
    ...
    <tr>    
     ...
     <std:input type="hidden" name="sect04" value="<%=(lastBean!=null)?lastBean.getId().substring(2,7):"00001" %>"/>
 </tr>
