...
<table class="tbldata" width="100%">
	...
	<tr>
		<td align="right"><i18n:label localeRef="mylocale" code="<%=StandardMessageTag.NATIONALITY%>"/>:</td>
		<td><%= selfNationality != null && selfNationality.getName() != null ? selfNationality.getName() : "" %></td>
	</tr>
	<tr>
		<td align="right"><i18n:label localeRef="mylocale" code="<%=StandardMessageTag.GENDER%>"/>:</td>
		<td>
			<%
				...
				if (gender != null) {
					...
					if (gender.equals("M"))
						gender = lang.display("GENERAL_MALE");
					else if (gender.equals("F"))	
						gender = lang.display("GENERAL_FEMALE");
	...
	<tr>
		<td align="right"><i18n:label localeRef="mylocale" code="<%=StandardMessageTag.MARRIAGE%>"/>:</td>
		<td>
			<%
				...
				if (marital != null) {
					...
					if (marital.equals("M"))
						marital = lang.display("GENERAL_YES");
					else if (marital.equals("S"))	
						marital = lang.display("GENERAL_NO");
