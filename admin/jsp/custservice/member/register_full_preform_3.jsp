...
<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.FULL_REG%>"/> - <i18n:label localeRef="mylocale" code="<%=MemberMessageTag.STEP_1%>"/>: <i18n:label localeRef="mylocale" code="<%=MemberMessageTag.PRE_CHECKING%>"/></div>
				...
				<table class="tbldata" width="100%">
					...
					<tr>
						...
						<td><input type="password" name="Password"></td>							
							...
							<std:input type="radio" name="Chek" value="1" status="onClick=\"javascript:showMenuChek('1');\""/><i18n:label code="Exclusive "/>
                                                    </td>                                                
                                                    </tr>
						...
						<td align="right"><span class="required note">* </span><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.MBRSHIP_REG%>"/>:</td>                                                
                                                    <td> <div id='menu0' style="display: visible;">
                                                         ...
                                                         <div id='menu1' style="display: visible;">
                                                            <std:input type="radio" name="Register" value="5" status=""/><i18n:label code="PAKET INTL."/>
                                                            <std:input type="radio" name="Register" value="6" status=""/><i18n:label code="PAKET 597"/>                                                            
                                                        </div>                                                        
                                                    </td>
