			...
			<td>
				<table class="tbldata" width="100%">
					<tr>
						...
						<td>
						    <std:input type="radio" name="Register" value="<%= MemberManager.REGTYPE_PINE %>" status="checked"/><i18n:label code="Pine Pollen"/>
                                                    <std:input type="radio" name="Register" value="<%= MemberManager.REGTYPE_SNACK %>" status=""/><i18n:label code="Snack Bar"/>
						    <std:input type="radio" name="Register" value="<%= MemberManager.REGTYPE_FAST %>" status=""/><i18n:label code="Fast Track"/>
						</td>
					</tr>					                                                                       
                                    <tr>
