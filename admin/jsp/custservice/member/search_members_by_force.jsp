...
<table class="listbox" width="100%" >
  <tr class="boxhead" valign=top>
    ...
    <td width="10%">Boutique</td>
        ...
        <td width="10%">Segment</td> <!-- Updated By Ferdi 2015-01-23 -->
  </tr>
  ...
  %>
    ...
    <td align="center"><b><%= beans[i].getSegmentationCRM() %></b></td> <!-- Updated By Ferdi 2015-01-23 -->
  </tr>
