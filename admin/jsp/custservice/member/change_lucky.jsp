...
<form name="frmSearch" action="<%=Sys.getControllerURL(MemberManager.TASKID_CHANGE_LUCKY,request)%>" method="post">

	<table class="noprint">
		<tr>
	    <td align="right"><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.DISTRIBUTOR_ID%>"/>:</td>
	    <td><std:input type="text" name="MemberID" value="" size="30" maxlength="20"/></td>	    
        </tr>
	</table>
