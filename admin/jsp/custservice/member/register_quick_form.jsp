...
<html>
    ...
    <body onLoad="self.focus(); init();">
        ...
        <form name="frmCreate" action="<%=Sys.getControllerURL(MemberManager.TASKID_FULL_PRE_REG_FORM_USR,request)%>" method="post">
                        ...
                        <table class="tbldata" width="100%">
                            <tr>
                                ...
                                <td> <div id='menu0' style="display: visible;">
                                        <std:input type="radio" name="Register" value="0" status= "checked"/><i18n:label code="Normal Retail &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="1" status= ""/><i18n:label code="VIP Retail &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="2" status=""/><i18n:label code="WholeSale &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="3" status=""/><i18n:label code="Special WholeSale &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="4" status=""/><i18n:label code="Staff &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="5" status=""/><i18n:label code="Corporate &nbsp;&nbsp;&nbsp;"/>                                        
                                    </div>
                                </td>
                            </tr>					                                                                                                                                               
                            <tr>
