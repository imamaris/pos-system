...
<%
	String editURL = Sys.getControllerURL(MemberManager.TASKID_COMPLETE_INCOMPLETE_REG,request);
...
<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.INCOMPLETE_REGISTERATION_FORM%>"/></div>	
...
<table class="listbox" width="100%">
  <tr class="boxhead" valign=top>
    ...
    <td width="13%"><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.IC%>"/> / <br> Incorporation No.</td>
