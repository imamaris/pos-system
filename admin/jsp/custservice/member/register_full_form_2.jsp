...
<div class="functionhead"><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.FULL_REG%>"/> - <i18n:label localeRef="mylocale" code="<%=MemberMessageTag.STEP_2%>"/>: <i18n:label localeRef="mylocale" code="<%=MemberMessageTag.COMPLETE_APP_FORM%>"/></div>
      ...
      <td><std:input type="date" name="JoinDateStr" value="<%= joinDateStr != null ? joinDateStr : "" %>" size="<%= size %>"/>&nbsp; (YYYY-MM-DD)</td>
		...
		<tr>
			...
			<td>                                                    
				...
				<std:input type="hidden" name="Register" value="<%= Register != null ? type : "" %>"/>
			</td>
		</tr>					                                                                       
		<tr>
