      	...
      	return;
			...
			if (!validateMemberRegisterFormNo(thisform.RegFormNo)) {
				...
				return;
                        ...
                        if (thisform.Register[1].checked) {
			    thisform.Register.value = thisform.Name.value;		
			...
			<td>
				<table class="tbldata" width="100%">
					<tr>
						...
						<td>
							<std:input type="radio" name="Register" value="<%= MemberManager.REGTYPE_STANDART %>" status="checked"/><i18n:label code="Standart"/>
