...
<script language="Javascript">
	...
	function doSubmit(){
		...
		}else if(isNaN(myform.sect03.value) || (myform.sect03.value * 1) < 0101 || (myform.sect03.value * 1) > 1231 ){
		   alert('Value must be an integer.');
		   myform.sect03.focus();
...
<form name="doc_gen" action="<%=Sys.getControllerURL(MemberPrintManager.TASKID_STARTER_SUBMIT_CHI, request)%>" method="post" onsubmit="return doSubmit();">
<table>
<tr>
      <td align=right>Code Start From : </td>
     <td> 
     <std:input type="text" name="sect01" value="000" maxlength="3" size="3"/>
     <std:input type="text" name="sect02" value="00" maxlength="2" size="2"/>
     <std:input type="text" name="sect03" value="0000" maxlength="4" size="4"/>
     <std:input type="text" name="sect04" value="" maxlength="3" size="3"/>
  	</td>
</tr>
<tr>
    <td align=right>Quantity : </td>
    <td align=left><b>1</b><std:input type="hidden" name="qty" value="1"/>
    </td>
</tr>
<tr>
    <td align=right>Tipe : </td>
    <td align=left><b>Internasional</b><std:input type="hidden" name="tipe" value="5"/>
    </td>
</tr>
