...
<head>
	...
	<script language="javascript">
		...
		function init() {
			...
			if (chek == '0')
				thisform.Chek[0].checked = true;
			else if (chek == '1')
				thisform.Chek[1].checked = true;                                                                
			else 
				thisform.Chek[2].checked = true;
	
			for(var i = 0; i < thisform.Chek.length; i++) {
				if(thisform.Chek[i].checked) {
					chekValue= thisform.Chek[i].value;
					showMenuChek(chekValue);
					break;
				}
			}                        
		...
		/*if (!validateMemberIdChi(thisform.OriginalID)) {
			alert("<i18n:label code="MSG_INVALID_MEMBERID"/>");
			focusAndSelect(thisform.OriginalID);
			return;
  		}
                */    
			...
			<td>
				<table class="tbldata" width="100%">
					...
					%>
                                                    ...
                                                    <tr>
                                                        <td align="right" width="180"><span class="required note">* </span><i18n:label code=" Type PIN "/>:</td>                                                
                                                        <td>
							<std:input type="radio" name="Chek" value="2" status="onClick=\"javascript:showMenuChek('2');\""/><i18n:label code="Paket INTL."/> 
							<std:input type="radio" name="Chek" value="1" status="onClick=\"javascript:showMenuChek('1');\" checked"/><i18n:label code="Paket 597"/>
                                                        <std:input type="radio" name="Chek" value="0" status="onClick=\"javascript:showMenuChek('0');\""/><i18n:label code="Standart "/>
                                                        </td>                                                
                                                    </tr>
					<!-- 
					<tr>
					...
					<tr>
						<td align="right"><span class="required note">* </span><i18n:label localeRef="mylocale" code="<%=MemberMessageTag.MBRSHIP_REG%>"/>:</td>                                                
                                                    <td> <div id='menu0' style="display: visible;">
                                                        ...
                                                        <std:input type="hidden" name="Register" value="6"/><i18n:label code="PAKET 597"/> <font color="red"><b>(NEW)</b></font>
                                                        </div>
                                                        <div id='menu2' style="display: none;">
                                                        <std:input type="hidden" name="Register" value="5"/><i18n:label code="PAKET INTL."/> <font color="red"><b>(Just For International Member)</b></font>
                                                        </div>
