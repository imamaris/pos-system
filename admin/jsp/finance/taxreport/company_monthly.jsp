...
<head>
	...
	<body>
	<div class="functionhead">Company Monthly Income Tax Report (Tax Art 23 Report)</div>
 	<form method="post" name="taxlist" action="<%=Sys.getControllerURL(BonusMasterReportManager.TASKID_ADMIN_COMPANY_TAX_REPORT ,request)%>">
