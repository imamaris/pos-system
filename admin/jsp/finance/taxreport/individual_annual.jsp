...
<head>
	...
	<body>
	<div class="functionhead">Individual Annual Income Tax Report  (Tax Art 21 Report)</div>
 	<form method="post" name="taxlist" action="<%=Sys.getControllerURL(BonusMasterReportManager.TASKID_ADMIN_ANNUAL_INDV_TAX_REPORT,request)%>">
