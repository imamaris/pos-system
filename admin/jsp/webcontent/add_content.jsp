...
function submitPost()
{
         document.postmsg.action="<%=Sys.getControllerURL(WebManager.TASKID_CONTENT_ADD_SUBMIT,request)%>";
         document.postmsg.target="";
...
<div class="functionhead"><i18n:label code="WEB_ADD_CONTENT"/></div>
...
<p class="required note">* <i18n:label code="GENERAL_REQUIRED_FIELDS"/></p>
	...
	<FCK:editor id="Contents" basePath="<%= (request.getContextPath() + "/fckeditor/") %>"
				...
				flashUploadURL="<%= (request.getContextPath() + "/fckeditor/editor/filemanager/upload/simpleuploader?Type=Flash") %>">				
	</FCK:editor>
