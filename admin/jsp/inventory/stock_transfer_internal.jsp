 ...
 function searchInventory(){
  ...
  var myform = document.ops_inventory;
	  ...
	  if(confirm('<i18n:label code="MSG_CONFIRM"/>'))  {
	     myform.action = '<%=Sys.getControllerURL(InventoryManager.TASKID_STOCK_PRE_TRANSFER_INTERNAL, request)%>%>';
	     myform.submit();
	  }else{
...
<div class=functionhead><i18n:label code="STOCK_TRANSFER_INTERNAL"/></div>

<form name="ops_inventory" action="<%=Sys.getControllerURL(InventoryManager.TASKID_STOCK_TRANSFER_INTERNAL, request)%>" method="post">
