...
return xmlHttpKit;
    ...
    <body onLoad="self.focus();document.ops_inventory.icode_1.focus();sumTotalQuantity();">
        ...
        <form name="ops_inventory" action="<%=Sys.getControllerURL(InventoryManager.TASKID_STOCK_TRANSFER_EXTERNAL_LOAN_IN, request)%>" method="post">
            ...
            <table width="100%">
                <tr>
                    <td width="9%">Doc. Date</td>
                    <td width="25%">:  <fmt:formatDate  pattern="dd MMMM yyyy" type="both" value="<%= new Date()%>" /> </td>                 
                    <td width="1%">&nbsp;</td>
                    <td width="10%">Reminder Date</td>
                    <td width="21%">:  <fmt:formatDate  pattern="dd MMMM yyyy" type="both" value="<%= startCal.getTime()%>" /> </td>       
                ...
                <tr>
                    ...
                    <b><%=from.getStoreID()%></b><input type=hidden name="_id" value="<%=from.getStoreID()%>">            </td>
                    <td>&nbsp;</td>
