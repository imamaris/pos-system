        ...
        <table class="listbox" width="100%">
            ...
            for (int i = 0; i < kivList.size(); i++) {
               ...
               if(kivBean.getQtyKiv() > 0)
                ...
                awal  = kivBean.getSkuCode().length();
                akhir = kivBean.getSkuCode().trim().length();
            %>  
            <tr valign="top">
            ...
            <td rowspan="<%= boList.size() %>">
                ...
                <br>
                <% if(awal > akhir) { %>
                Ref. Number: <std:text value="<%= kivBean.getProductCode() %>"/>  <b><font color="blue"><std:text value="<%= kivBean.getProductType().equalsIgnoreCase("Y") ? sn.concat(" ").concat(kivBean.getSkuCode()).concat(")") : " " %>"/></font></b>
                <% } else { %>
            ...
            <% }
             ...
             %>
                ...
                <td nowrap>
                    ...
                    <a href="<%= Sys.getControllerURL(102060,request) %>&CustomerID=<%= sales.getCustomerID() %>&CustomerName=<%= sales.getCustomerName() %>">  <%= sales.getCustomerID() %> </a>
            ...
            <tr valign=top>
                <td align="left" colspan="8"><marquee> <font color="blue">  Please click on the Customer ID for processing Loan IN </font></marquee></td>
            </tr>
