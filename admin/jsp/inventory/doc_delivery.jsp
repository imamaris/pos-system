...
<table class="tbldata" width="600">
  ...
  <table class="tbldatabaru" border="0" width="600">                
	  ...
	  <td colspan=2 align=center width="450"><hr></td>
        ...
        <tr valign=top>
            <td colspan=2 align=center width="450"> <font size="4" style="bold"> DELIVERY NOTE </font></td>
	</tr>        
         <tr valign=top>
	  <td colspan=2 align=center width="450"><hr></td>
	</tr>
        ...
        <tr valign="top">
		<td valign=top>
			<%@ include file="/admin/jsp/inventory/view_delivery_document_tag.jsp"%>
		</td>
	</tr>  
	...
	<tr valign=top>
		<td colspan="2" width="450">
		  <%@ include file="/admin/jsp/inventory/view_delivery_cart_tag.jsp"%>         
		</td>
	</tr>        
	  ...
	  <td colspan="2" height="15"></td>   
       ...
       <tr valign="top">
		<td valign=top width="500">
			<%@ include file="/admin/jsp/inventory/view_delivery_customer_tag.jsp"%>
		</td>
	</tr>   
	...
	<tr class=baru align="center">
	  ...
	  <td colspan="2"></td>   
       ...
       <tr class=baru align="center">
		<td  colspan="2" align="left">Validation No. : <%= doBean.getTrxDocNo().getBytes()%> </td>
	</tr>    
  
        <tr class=baru align="center">
		<td colspan="2" align="left">Printed By : <%= doBean.getStd_createBy() %></td>
	</tr>	       
