...
<table width="100%">
 <tr>
   ...
   <%if(invenBean.getTrnxType().equalsIgnoreCase("SKLO") && invenBean.getStatus() == 100)
        { %>
        
            <td width="80%" align="right" class=noprint > <font color="blue"> <b>This document has been Verified Loan OUT </b> </font> </td>     
                    ...
                    <table width="100%" border="0">
                        ...
                        <table width="100%" border="0" >  
                            ...
                            for(int i=0; i<invenBeans.length; i++){
                                ...
                                if(invenBeans[i].getTrnxType().equalsIgnoreCase("SKLO") && invenBeans[i].getProductBean().getProductSelling().equalsIgnoreCase("Y")) {
