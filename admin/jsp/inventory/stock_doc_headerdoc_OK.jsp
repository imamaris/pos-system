	<table width="100%">
	      <tr>
	        ...
	        <td valign=top width=50%>
	      	  <table width="100%">
	      	    <tr>
	      	      <td colspan=3 align=right><b><font size=4 face="Arial"><%=document_name%></font></b></td>
	      	    </tr>
	      	    <tr>
	      	      <td align=right><b><i18n:label localeRef="mylocale" code="<%=InventoryMessageTag.REFERENCE_NO%>"/></b></td>
	      	      <td>:</td>
