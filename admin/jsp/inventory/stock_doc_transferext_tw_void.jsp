...
<table width="100%">
 <tr>
   ...
   <%if(invenBean.getStatus() == 40 || invenBean.getStatus() == 50)
        { %>
        
            <td width="80%" align="Left"> <font color="blue"> <b>This document has been VOIDED </b> </font> </td>     
 
        <% 
        } else {      
        %> 
        
            <td width="80%" align="Left"> <font color="blue"> <b>This document has been ACTIVE </b> </font> </td>   
