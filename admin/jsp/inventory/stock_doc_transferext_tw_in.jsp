...
<body onLoad="self.focus();">
    ...
    <table width="100%">
        ...
        <tr>     
            <%if(invenBean.getTrnxType().equalsIgnoreCase("STAI") && invenBean.getStatus() == 100)
            { %>
            <table width="35%" border="1" cellspacing="1" cellpadding="1">
                <tr>    
                    <td align=center height="30" > <font color="red"> <b><std:doc_invt doc="IN" value2= "<%=invenBean.getTrnxDocNo() %>" value=" Process Verify IN " type="1"/> </b> </font></td>      
                </tr>
            </table>
            <% 
            } else if (invenBean.getTrnxType().equalsIgnoreCase("STEI") && invenBean.getStatus() == 100) {      
            %> 
            
            <td align="right"> <font color="blue"> <b>This document has been Verified IN </b> </font> </td>   
            
            <% 
            } else {      
            %> 
            
            <td align="right"> <font color="blue"> <b>This document has been VOIDED </b> </font> </td>   
                    ...
                    <table width="100%" border="0" >  
                        ...
                        for(int y=0; y<invenBeans.length;y++){
                            if(invenBeans[y].getProductBean().getProductSelling().equalsIgnoreCase("N")) {
                                ...
                                if(!invenBeans[y].getTrnxType().equalsIgnoreCase("STAI")) {                                    
                                    jumlah1[nom-1] = invenBeans[y].getTotalOut();
                                }else{ 
