...
<table width="100%">
 <tr>
   ...
   <%if(!invenBean.getTrnxType().equalsIgnoreCase("STEO"))
        { %>
        
            <td width="80%" align="right" class=noprint > <font color="blue"> <b>This document has been Verified OUT </b> </font> </td>     
 
        <% 
        } else {      
        %> 
        
            <td width="80%" align="right"> <font color="blue"> <b>This document has been Verified IN </b> </font> </td>   
                    ...
                    <table width="100%" border="0">
                        ...
                        <table width="100%" border="0" >  
                            ...
                            for(int i=0; i<invenBeans.length; i++){
                                ...
                                if(!invenBeans[i].getTrnxType().equalsIgnoreCase("STEI") && invenBeans[i].getProductBean().getProductSelling().equalsIgnoreCase("Y")) {
                            ...
                            for(int y=0; y<invenBeans.length; y++){
                                if(!invenBeans[y].getTrnxType().equalsIgnoreCase("STEI") && invenBeans[y].getProductBean().getProductSelling().equalsIgnoreCase("N")) {
                                    nom++;
                                    // simpan ke array
