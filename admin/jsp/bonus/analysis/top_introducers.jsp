...
<table class="listbox" width="70%">
		  <tr class="boxhead">
		  		...
		  		<td align="center">Previous Direct<br>Group Size</td>
		  		<td align="center">Current Direct<br>Group Size</td>
		        <td align="center">New Direct<br>Recruits</td>
		  </tr>
...
%>
		   <tr class="<%=((i%2==1)?"odd":"even")%>" >
		  		...
		  		<td align="center"><%=beans[i].getOldDirectGroupSize()%></td>
		  		<td align="center"><%=beans[i].getDirectGroupSize()%></td>
		  		<td align="center"><%=(beans[i].getDirectGroupSize()-beans[i].getOldDirectGroupSize())%></td>
