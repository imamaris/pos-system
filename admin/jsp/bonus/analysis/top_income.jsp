...
<table class="listbox" width="60%">
		  <tr class="boxhead">
		  		...
		  		<td align="center">Total Bonus<br>
		  		<td align="center">Accum Bonus</br>
		  </tr>
...
%>
		   <tr class="<%=((i%2==1)?"odd":"even")%>" >
		  		...
		  		<td align="right"><%=dollar.format(beans[i].getTotalBonus())%><br>
		  		<td align="right"><%=dollar.format(beans[i].getAccumBonus())%></br>
		  </tr>	
