...
<%@page import="com.ecosmosis.orca.bonus.chi.BonusBean"%>
...
%> 
	...
	<div class="functionhead">Payment Rekapitulation</div>
 	<form method="post" name="taxpayment" action="<%=Sys.getControllerURL(BonusMasterReportManager.TASKID_ADMIN_WEEKLY_PAYMENT_REKAP, request)%>">
