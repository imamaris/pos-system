	...
	<table class="listbox" width="600">
		 ...
		 <tr>
		 	...
		 	<td align="right"><%=dollar.format(bean.getTax())%></td>
                 ...
                 <% if (bean.getAdjustment() > 0.0d || bean.getAdjustment() < 0.0d) { %>
                 <tr>
                     <td align="right"><div><font color="blue">Adjusment Tax </div></td>
                     <td align="right">&nbsp;</td>
                     <td align="right"><div><font color="blue"><%=dollar.format(bean.getAdjustment())%></div></td>
		 </tr>
		 <% } %>
		 ...
		 <tr>
		 	...
		 	<td align="right">&nbsp;</td>
		 	<td align="right"><%=dollar.format(bean.getTotalBonus()-bean.getTax() -bean.getAdjustment()- bean.getAdminfees()- bean.getOthersfee())%></td>
		 </tr>
		  <tr>
