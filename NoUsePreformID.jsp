...
try {
    ...
    String query = "SELECT mbr_mbrid, mbr_name, mbr_deposit, mbr_idcrm, mbr_idcrm_valid, mbr_segmentation, mbr_mobileno " +
            " FROM member " +
            " WHERE mbr_mbrid='"+sku_kode+"' order by mbr_idcrm desc ";
