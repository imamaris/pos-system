...
public class InventoryManager_1 extends DBTransactionManager {
    ...
    private InventoryBroker_1 broker;
    
    public InventoryManager_1() {
        broker = null;
    }
    
    public InventoryManager_1(Connection _con) {
        super(_con);
        broker = null;
    }
    
    private InventoryBroker_1 getBroker(Connection conn) {
        if(broker == null)
            broker = new InventoryBroker_1(conn);
        else
                ...
                case 102044:
                {
                    ...
                    if(id != null) {
                        ...
                        if(taskId == 0x18e9c) {
                            ...
                            InventoryManager_1 inventoryManager = new InventoryManager_1();
