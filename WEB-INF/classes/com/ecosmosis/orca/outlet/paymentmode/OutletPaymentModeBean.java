...
public class OutletPaymentModeBean extends MvcBean
{
        ...
        throws SQLException
    {
        ...
        setPaymodeCode(rs.getString((new StringBuilder(String.valueOf(prefix))).append("opm_paymodecode").toString()));   
        setPaymodeDesc(rs.getString((new StringBuilder(String.valueOf(prefix))).append("opm_paymodedesc").toString())); 
