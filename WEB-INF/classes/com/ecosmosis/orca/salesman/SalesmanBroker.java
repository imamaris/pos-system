...
public class SalesmanBroker extends DBTransactionBroker
{
    ...
    protected static final String SQL_MEMBER_PROFILE = "select m.*,  n.loc_name as selfnat_loc_name, sp.loc_name as spnat_loc_name, bf.loc_name as bfnat_loc_name, c.loc_name as ctry_loc_name, s.loc_name as state_loc_name, i.loc_name as city_loc_name, mc.loc_name as mail_ctry_loc_name, ms.loc_name as mail_state_loc_name, mi.loc_name as mail_city_loc_name ,  b.*,  t.*  from salesman m  left join locations n on m.mbr_nationalityid = n.loc_id left join locations sp on m.mbr_spouse_nationalityid = sp.loc_id left join locations bf on m.mbr_bf_nationalityid = bf.loc_id left join locations c on m.mbr_countryid = c.loc_id left join locations s on m.mbr_stateid = s.loc_id left join locations i on m.mbr_cityid = i.loc_id left join locations mc on m.mbr_mailing_countryid = mc.loc_id left join locations ms on m.mbr_mailing_stateid = ms.loc_id left join locations mi on m.mbr_mailing_cityid = mi.loc_id  left join bank b on m.mbr_bankid = b.bnk_bankid  left join member t on m.mbr_intrid = t.mbr_mbrid ";
    protected static ArrayList likeFields;

    protected SalesmanBroker(Connection con)
    {
        super(con);
    }
        ...
        throws MvcException, SQLException
    {
        ...
        stmt = null;
        rs = null;
        SQL = (new StringBuilder("select * from salesman")).append(conditions.getConditions()).append(conditions.getOrderby()).append(conditions.getLimitConditions()).toString();
        try
        {
        ...
        throws MvcException, SQLException
    {
        ...
        SQL = "select * from salesman where mbr_hidden = 'N' ";
        if(hasMemberID)
        ...
        throws MvcException, SQLException
    {
        ...
        stmt = null;
        rs = null;
        SQL = "select * from salesman where mbr_mbrid=? order by mbr_seq";
        try
        {
            int i = 1;
            stmt = getConnection().prepareStatement(SQL);
    ...
    protected SalesmanBean getMemberByID(String memberID, boolean parseFullInfo)
        throws MvcException, SQLException
    {
        return getMemberByID(memberID, null, parseFullInfo);
    }

    protected SalesmanBean getMemberByID(String memberID, String branchID, boolean parseFullInfo)
        throws MvcException, SQLException
    {
        SalesmanBean bean;
        PreparedStatement stmt;
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                try
                {
                    SalesmanBean intr = new SalesmanBean();
    ...
    protected SalesmanBean getMemberBySeq(int memberSeq, boolean parseFullInfo)
        throws MvcException, SQLException
    {
        SalesmanBean bean;
        PreparedStatement stmt;
    ...
    protected SalesmanBean getMember(int memberSeq, String memberID, boolean parseFullInfo)
        throws MvcException, SQLException
    {
        SalesmanBean bean;
        PreparedStatement stmt;
        ...
        stmt = null;
        rs = null;
        SQL = "select * from salesman where mbr_seq=? and mbr_mbrid=?";
        try
        {
            int i = 1;
            stmt = getConnection().prepareStatement(SQL);
        ...
        throws MvcException, SQLException
    {
        ...
        stmt = null;
        rs = null;
        SQL = "select mbr_mbrid from salesman where mbr_seq=?";
        try
        {
            int i = 1;
            stmt = getConnection().prepareStatement(SQL);
   ...
   protected SalesmanChecklist checkRegisterChecklist(SalesmanBean member)
        throws MvcException, SQLException
    {
        SalesmanChecklist chkList = new SalesmanChecklist();
        try
        {
    ...
    protected SalesmanChecklist checkDupIdentity(SalesmanBean member)
        throws MvcException, SQLException
    {
        SalesmanChecklist chkList = new SalesmanChecklist();
        try
    ...
    protected void checkDupRegFormNo(SalesmanChecklist chkList, String formNo)
        throws MvcException, SQLException
    {
        PreparedStatement stmt;
        ResultSet rs;
        ...
        stmt = null;
        rs = null;
        SQL_sameFormNo = "select * from salesman where mbr_register_formno=? and mbr_status not in (50) order by mbr_register_formno, mbr_seq";
        try
        {
            int count = 0;
            int i = 1;
    ...
    protected void checkDupMember(SalesmanChecklist chkList, String identityNo, String memberID)
        throws MvcException, SQLException
    {
        PreparedStatement stmt;
        ResultSet rs;
        ...
        stmt = null;
        rs = null;
        SQL_dup = "select * from salesman where mbr_identityno=? or mbr_company_registerno=? or mbr_nric=? or mbr_oldnric=? or mbr_passport=? or mbr_mbrid=?  and mbr_status not in (50) order by mbr_status, mbr_seq";
        try
        {
            int count = 0;
            int i = 1;
    ...
    protected void checkDupIdentity(SalesmanChecklist chkList, String identityNo)
        throws MvcException, SQLException
    {
        PreparedStatement stmt;
        ResultSet rs;
        ...
        stmt = null;
        rs = null;
        SQL_dup = "select * from salesman where mbr_identityno=? or mbr_company_registerno=? or mbr_nric=? or mbr_oldnric=? or mbr_passport=?  and mbr_status not in (50) order by mbr_status, mbr_seq";
        try
        {
            int count = 0;
            int i = 1;
    ...
    protected boolean addMemberBonusStatus(SalesmanBean member)
        throws MvcException, SQLException
    {
        boolean status;
        PreparedStatement stmt;
    ...
    protected boolean quickRegisterMember(SalesmanBean member)
        throws MvcException, SQLException
    {
        boolean status;
        PreparedStatement stmt;
    ...
    protected boolean fullRegisterMember(SalesmanBean member)
        throws MvcException, SQLException
    {
        boolean status;
        PreparedStatement stmt;
    ...
    protected boolean updateMember(SalesmanBean member)
        throws MvcException, SQLException
    {
        boolean status;
        PreparedStatement stmt;
        ...
        throws MvcException, SQLException
    {
        ...
        try
        {
            ...
            System.out.println("masuk getFullList " + count );   

        }
        catch(SQLException sqlex)
        {
            Log.error(sqlex);
            throw new MvcException((new StringBuilder("Error while Loading Salesman Info --> ")).append(sqlex).toString());
        }
        finally
        {
        if(stmt != null)
    ...
    static 
    {
        ...
        likeFields.add(SalesmanBean.FIELD_ID);
        likeFields.add(SalesmanBean.FIELD_NAME);
        likeFields.add(SalesmanBean.FIELD_IDENTITY_NO);
        likeFields.add(SalesmanBean.FIELD_OFFICE);
        likeFields.add(SalesmanBean.FIELD_FAX);
        likeFields.add(SalesmanBean.FIELD_HOME);
        likeFields.add(SalesmanBean.FIELD_MOBILE);
    }
}
