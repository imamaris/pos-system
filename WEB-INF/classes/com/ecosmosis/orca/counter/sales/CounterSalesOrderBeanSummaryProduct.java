...
public class CounterSalesOrderBeanSummaryProduct extends MvcBean
{
    ...
    public CounterSalesOrderBeanSummaryProduct()
    {
        immediateDelivery = "N";
        displayDelivery = "N";
    }
        ...
        throws SQLException
    {
        ...
        setProductCategory(rs.getString((new StringBuilder(String.valueOf(prefix))).append("product_category_desc.pcd_name").toString()));
        ...
        //counter_sales_item.csi_bv1,
        setBv1(rs.getDouble((new StringBuilder(String.valueOf(prefix))).append("csi_bv1").toString()));
        setPriceSale(rs.getDouble((new StringBuilder(String.valueOf(prefix))).append("csi_unit_price").toString()));
        setQtySale(rs.getInt((new StringBuilder(String.valueOf(prefix))).append("csp_qty_order").toString()));
        setNetSale(rs.getInt((new StringBuilder(String.valueOf(prefix))).append("csp_net_order").toString()));
  ...
  /*
    private void parseCounterSalesItemBean(ResultSet rs, String prefix)
        throws SQLException
    {
        if(prefix == null)
            prefix = "";
        CounterSalesItemBean salesitem = new CounterSalesItemBean();
        
                
        salesitem.setProductID(rs.getInt((new StringBuilder(String.valueOf(prefix))).append("csi_productid").toString()));

        setCounterSalesItemBean(salesitem);
    }
