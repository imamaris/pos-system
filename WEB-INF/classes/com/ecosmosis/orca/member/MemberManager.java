...
import com.ecosmosis.orca.counter.sales.CounterSalesItemBean;
...
public class MemberManager extends DBTransactionManager
{
    ...
    public static final int TASKID_COMPLETE_PAKET1100_REG = 0x19668;
    
    public static final int TASKID_BASIC_EDIT_MEMBER = 0x19649;
    public static final int TASKID_SPECIAL_EDIT_MEMBER = 0x1964a;
    public static final int TASKID_SPECIAL_EDIT_MEMBER_TAX = 0x19664;
    
    public static final int TASKID_SEARCH_MEMBERS_BY = 0x1964b;
    public static final int TASKID_SEARCH_MEMBERS_BY_SALES = 0x19666;
    public static final int TASKID_SEARCH_MEMBERS_BY_FORCE = 0x19667;
    public static final int TASKID_SEARCH_MEMBERS_BY_LOAN = 0x19669;    
    ...
    public static final int TASKID_CHANGE_LUCKY = 0x1966b;
    ...
    public static final int TASKID_SEARCH_MEMBERS_BY_USR = 0x31514;
    ...
    public static final String RETURN_OCCUPATION_CODE = "OccupationType"; //Updated By Ferdi 2015-01-21
    public static final String RETURN_ETHNIC_CODE = "EthnicType"; //Updated By Ferdi 2015-01-23
    
    public static final String RETURN_TYPE_CODE = "MemberType";
    public static final String RETURN_GENDER_CODE = "GenderType";
    
    public static final String RETURN_BRANCH_CODE = "BranchType";
    
    public static final String RETURN_MARITAL_CODE = "MaritalType";
    public static final String RETURN_MBRBEAN_CODE = "MemberBean";
    public static final String RETURN_SALESBEAN_CODE = "SalesBean";
        
    public static final String RETURN_MBRLIST_CODE = "MemberList";
    public static final String RETURN_MBRLIST_CODE2 = "MemberList2";
    public static final String RETURN_MBRLIST_CODE3 = "MemberList3";
    ...
    public static final MemberBean EMPTY_ARRAY_MEMBER[] = new MemberBean[0];
    private MemberBroker broker;
   ...
   // private
    public MemberBroker getBroker(Connection conn)
    {
        if(broker == null)
            broker = new MemberBroker(conn);
        else
...
/*
                                        ...
                                        <std:input type="radio" name="Register" value="1" status= ""/><i18n:label code="VIP Retail &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="3" status=""/><i18n:label code="WholeSale &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="4" status=""/><i18n:label code="Special WholeSale &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="5" status=""/><i18n:label code="Staff &nbsp;&nbsp;&nbsp;"/>
                                        <std:input type="radio" name="Register" value="6" status=""/><i18n:label code="Corporate &nbsp;&nbsp;&nbsp;"/>                                        
 */        
    ...
    public static String defineRegisterType2(String Register)
    {
        ...
        if(Register.equals("3"))
            title = "WholeSale";
        else            
        if(Register.equals("4"))
            title = "Special WholeSale";
        else        
        if(Register.equals("5"))
            title = "Staff";
        else 
        if(Register.equals("6"))
            title = "Corporate";
        else 
        if(Register.equals("7"))
            title = "Corporate 2";
        else 
        if(Register.equals("8"))
            title = "Corporate 3";
        else 
    ...
    public static String defineMbrTitle(String type)
    {
        String title = "";
        if(type == null)
            return title;
    ...
    public static String defineMbrGender(String type)
    {
        String title = "";
        if(type == null)
            return title;
        ...
        throws Exception
    {
        ...
        map.put("mbr_home_branchid", "Boutique");
        return map;
    }
        ...
        throws Exception
    {
        ...
        if(showDefault)
        map.put("", "Any");
        map.put(String.valueOf(0), defineRegister("0")); 
        map.put(String.valueOf(1), defineRegister("1"));        
        map.put(String.valueOf(2), defineRegister("2"));       
        map.put(String.valueOf(4), defineRegister("4"));  
        map.put(String.valueOf(5), defineRegister("5"));  
        map.put(String.valueOf(6), defineRegister("6"));  
        map.put(String.valueOf(7), defineRegister("7"));  
        map.put(String.valueOf(8), defineRegister("8"));  
        map.put(String.valueOf(9), defineRegister("9"));  
        return map;
    }

     public static synchronized String defineRegister(String Register)
    {
        String title = "";
        if(Register == null)
            return title;
        if(Register.equals("0"))
            title = "PAKET KIT BASIC";
        else
        if(Register.equals("1"))
            title = "PAKET KIT KOMBINASI";
        else
        if(Register.equals("2"))
            title = "PAKET 389rb";
        else
    ...
    public FIFOMap getMapForOccupationType()
        throws Exception
    {
        FIFOMap map = new FIFOMap();
        map.put("", "[OCCUPATION]");
        map.put("Professional", "Professional");
        map.put("Self Employed", "Self Employed");
    ...
    public FIFOMap getMapForEthnicType()
        throws Exception
    {
        FIFOMap map = new FIFOMap();
        map.put("", "[ETHNICITY]");
        map.put("Indonesia", "Indonesia");
        map.put("Indo-Chinese", "Indo-Chinese");
        map.put("Kaukasian", "Kaukasian");
        map.put("India", "India");
        map.put("Arab", "Arab");
        map.put("Others", "Others");
        return map;
    ...
    public FIFOMap getMapForBranchType()
        throws Exception
    {
        FIFOMap map = new FIFOMap();
        map.put("", "Any");
        map.put("Jakarta", "Jakarta");
        map.put("Bandung", "Bandung");
        map.put("Surabaya", "Surabaya");
        return map;
    }
    ...
    private void prepareNewMember(MemberBean member)
        throws MvcException
    {
        ...
        member.setOriginalID(member.getOriginalID());
        ...
        if(member.getIdentityType().equals("K") && member.getNric() == null)
            member.setNric(member.getIdentityNo());
        else
        if(member.getIdentityType().equals("S") && member.getNric() == null)
            member.setNric(member.getIdentityNo());
        else
        ...
        {
            MemberBean intrBean = getMemberByID(member.getIntroducerID(), false);
            if(intrBean != null)
            {
        ...
        {
            MemberBean placeBean = getMemberByID(member.getPlacementID(), false);
            if(placeBean != null)
            {
    ...
    public void assignPassword(MemberBean member)
        throws MvcException
    {
        try
        {
    ...
    private void upperCaseBean(MemberBean bean)
    {
        if(bean == null)
            return;
        ...
        // for HighEnd
        String noid = "T";
        noid = (new StringBuilder(String.valueOf(noid))).append(bean.getMobileNo()).toString();
        bean.setMemberID(noid.toUpperCase());
    ...
    private void parseBean(MemberBean bean, HttpServletRequest request, boolean parseMemberBeanOnly)
        throws Exception
    {
        ...
        System.out.println("masuk parseBean, noPin1 "+ noPin +"");  
        ...
        throws MvcException
    {
        ...
        try
        {
            MemberBean bean = getMemberByID(memberID, false);
            if(bean != null)
                status = true;
        }
        catch(Exception e)
    ...
    public boolean isActiveVoucher(String voucherID)
        throws MvcException
    {
        boolean status = false;
        try
        {
            MemberBean bean = getMemberByID(voucherID, false);
            if(bean != null)
                status = bean.getStatus() == 10;
        }
        catch(Exception e)
    ...
    private MvcReturnBean checkPreRegisterForm(HttpServletRequest request)
    {
        ...
        try
        {
            ...
            */
            ...
            sbParam.append((new StringBuilder("&Gender=")).append(member.getGender()).toString()); //Updated By Ferdi 2015-01-21
            sbParam.append((new StringBuilder("&Salutation=")).append(member.getTitle()).toString()); //Updated By Ferdi 2015-01-21
            sbParam.append((new StringBuilder("&Name=")).append(member.getName()).toString());
            sbParam.append((new StringBuilder("&MobileNo=")).append(member.getMobileNo()).toString());
            ...
            sbParam.append((new StringBuilder("&OriginalID=")).append(member.getOriginalID()).toString()); 
            ...
            if(!member.isChkPin())
            {
                ...
                System.out.println("masuk !member.isChkPin() ");
            ...
            } else
            {
                ...
                System.out.println("masuk ELSE !member.isChkPin() ");
            }
...
/*    
  ...
  */
    ...
    private boolean checkRegisterInput(MemberBean member, MvcReturnBean returnBean, HttpServletRequest request)
    {
        
        // System.out.println("checkRegisterInput Awal : "+ member); 
        ...
        if(member.getMemberID() == null || member.getMemberID() != null && member.getMemberID().length() <= 0)
            ...
            // System.out.println("checkRegisterInput Kedua : "+ member.getMemberID()); 
        ...
        if(member.isChkPin())
        {
            ...
            {                
                ...
                {                        
                    // chek, kenapa selalu 597
                    System.out.println("0. Register Type "+defineRegisterType(member.getRegister()));
                    
                    if(member.getPassword() == null || !idBean.getEpin().equals(member.getPassword()))                        
                       {
                        returnBean.addError("Pin number NOT MATCHED ("+member.getPassword()+"), Please to BACK");
                        System.out.println("NOT MATCHED -> Pin number : "+ idBean.getEpin()+" Type Register 1 (mbi_refno) : "+ idBean.getReferenceNo()+" register "+ member.getRegister());
                       }
                    
                    
                    if(!idBean.getReferenceNo().equals("5"))
                    {
                    if(!idBean.getReferenceNo().equals("6") && member.getRegister() == 6 )
                      {  
                      System.out.println("1. Register Type NOT MATCHED, not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                      }
                    } 
                    
                    if(idBean.getReferenceNo().equals(null) && member.getRegister() == 6 ) 
                     {  
                      System.out.println("2. Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+")");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }

                    if(member.getRegister() < 6  && idBean.getReferenceNo().equals("6")) 
                     {  
                      System.out.println("3. Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+")");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }

                    if(member.getRegister() == 7  && idBean.getReferenceNo().equals("6")) 
                     {  
                      System.out.println("3. Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+")");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }
                    
                    if(member.getRegister() < 6  && idBean.getReferenceNo().equals("7"))
                     {  
                      System.out.println("3. Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+")");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }

                    if(idBean.getReferenceNo().equals("0") && member.getRegister() == 7 ) 
                    {  
                      System.out.println("1. Register Type NOT MATCHED, not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }
                    ...
                    // tambahan paket 260
                    if(idBean.getReferenceNo().equals("9") && member.getRegister() < 9 ) 
                    {  
                      System.out.println("1. Register Type NOT MATCHED, not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                      returnBean.addError("Register Type NOT MATCHED, Not ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }                    
                ...
                {
                    System.out.println("This member ID had been USED : "+ idBean.getId()); 
                    returnBean.addError("This member ID had been USED, Please to BACK");                    
                }
                                
            }             
            else
            {
                System.out.println("This member ID is NOT EXIST in the System : "+ idBean.getId()); 
                returnBean.addError("This member ID is NOT EXIST in the System, Please to BACK");
            }
        }
        */
        ...
        catch(Exception e)
        {
            if(member.getJoinDateStr() != null && member.getJoinDateStr().length() > 0)
                returnBean.addError("Fail to parse Join Date, Please to BACK");
            else
        ...
        catch(Exception ignore)
        {
            if(member.getJoinTimeStr() != null && member.getJoinTimeStr().length() > 0)
                returnBean.addError("Fail to parse Join Time, Please to BACK");
        }
        
        
        if(member.getType() == null || member.getType() != null && member.getType().length() <= 0)
            returnBean.addError("No Membership Type specified, Please to BACK");
        ...
        if(member.getRegFormNo() == null || member.getRegFormNo() != null && member.getRegFormNo().length() <= 0)
            returnBean.addError("No Register Form No. specified, Please to BACK");
        
        if(member.getName() == null || member.getName() != null && member.getName().length() <= 0)
            returnBean.addError("No Name specified, Please to BACK");
 
        if(member.getMobileNo() == null || member.getMobileNo() != null && member.getMobileNo().length() <= 0)
            returnBean.addError("No Mobile Number specified, Please to BACK");        
        
       // remark sementara
       /* 
        if(member.getIdentityType() == null || member.getIdentityType() != null && member.getIdentityType().length() <= 0)
            returnBean.addError("No Identity Type specified, Please to BACK");
        if(member.getIdentityNo() == null || member.getIdentityNo() != null && member.getIdentityNo().length() <= 0)
            returnBean.addError("No Identity No. specified, Please to BACK");
       */
        ...
        catch(Exception e)
        {
            if(member.getCompanyRegDateStr() != null && member.getCompanyRegDateStr().length() > 0)
                returnBean.addError("Fail to parse Incorporation Date, Please to BACK");
        }
        ...
        try
        {
            ...
            if(member.getDob() != null && PersonUtil.isBelowAge(member.getDob(), 18))
                returnBean.addError("The member is under age 18, Please to BACK");
             */
        }
        ...
        catch(Exception e)
        {
            if(member.getDobStr() != null && member.getDobStr().length() > 0)
                returnBean.addError("Fail to parse DOB, Please to BACK");
        }
        if(member.getSpouse() != null)
            ...
            catch(Exception e)
            {
                if(member.getSpouse().getSpouseDobStr() != null && member.getSpouse().getSpouseDobStr().length() > 0)
                    returnBean.addError("Fail to parse Spouse DOB, Please to BACK");
            }
        ...
        /* chek joindate
        String Sjoindate = member.getJoinDateStr().trim();
        String Sbonusdate = member.getBonusPeriodID().trim();
        
        String jmonth = Sjoindate.trim().substring(5,7);
        String jyear  = Sjoindate.trim().substring(0,4);              
        String jmonthyear  = jyear.concat(jmonth);
        
        String bmonth = Sbonusdate.trim().substring(5,7);
        String byear  = Sbonusdate.trim().substring(0,4);              
        String bmonthyear  = byear.concat(bmonth);
         
        System.out.println("jmonthyear " + jmonthyear + " bmonthyear " + bmonthyear); 
        
        if(!jmonthyear.equalsIgnoreCase(bmonthyear))
            returnBean.addError("Join Date not matched with Bonus Date, Please to BACK");
        */  
        
        return !returnBean.hasErrorMessages();
    }

    private boolean RegisterInput(MemberBean member, MvcReturnBean returnBean, HttpServletRequest request)
    {
        if(member.getMemberID() == null || member.getMemberID() != null && member.getMemberID().length() <= 0)
            returnBean.addError("No Distributor ID specified");
        ...
        if(member.isChkPin())
        {
            ...
            if(idBean != null)
            {
                if(idBean.getStatus() == 0)
                {
                    if(member.getPassword() == null || !idBean.getEpin().equals(member.getPassword()))                        
                        returnBean.addError("Pin number NOT MATCHED ("+member.getPassword()+"), Please to BACK" );
                        System.out.println("RegisterInput GAGAL : "+ member.getPassword()+ "Status :" + idBean.getStatus()); 
                        
                    if(!idBean.getReferenceNo().equals("6") && member.getRegister() == 6 ) 
                     {  
                      System.out.println("Register Type NOT MATCHED ("+defineRegisterType(member.getRegister())+")");
                      returnBean.addError("Register Type NOT MATCHED ("+defineRegisterType(member.getRegister())+"), Please to BACK");
                     }
                ...
                {
                    //  System.out.println("RegisterInput BERHASIL : "+ member.getPassword()+ "Status :" + idBean.getStatus());  
    ...
    private void checkIntroducer(MemberBean member, MvcReturnBean returnBean)
    {
        boolean chkIntrBean;
        boolean chkPlaceBean;
        MemberBean intrBean;
        MemberBean placeBean;
        Connection conn;
        chkIntrBean = false;
        chkPlaceBean = false;
        intrBean = null;
        ...
        try
        {
            ...
            if(member.hasIntroducerRef())
                try
                {
                    ...
                    {
                        returnBean.addError("No Upline ID found in the system, Please to BACK");
            ...
            if(member.hasPlacementRef())
                try
                {
                    ...
                    {
                        returnBean.addError("No Sponsor ID found in the system, Please to BACK ");
            ...
            try
            {
                if(member.hasPlacementRef() && member.hasIntroducerRef() && placeBean != null && !member.getIntroducerID().equalsIgnoreCase(member.getPlacementID()))
                {
                    ...
                    if(!isDownline && intrBean != null)
                        returnBean.addError("Upline ID is not Sponsor downline, Please to BACK");
                }
            }
            catch(Exception ex)
            {
            ...
            if(member.getMemberID() != null && member.getIntroducerID() != null && member.getMemberID().equalsIgnoreCase(member.getIntroducerID()))
                returnBean.addError("Upline ID cannot same as Member ID, Please to BACK");
            if(member.getMemberID() != null && member.getPlacementID() != null && member.getMemberID().equalsIgnoreCase(member.getPlacementID()))
                returnBean.addError("Sponsor ID cannot same as Member ID, Please to BACK");
            if(intrBean != null)
            {
                member.setIntroducerName(intrBean.getName());
                member.setIntroducerIdentityNo(intrBean.getIdentityNo());
    ...
    private boolean checkRegisterChecklist(MemberBean member, MvcReturnBean returnBean)
        throws MvcException
    {
        boolean success;
        Connection conn;
    ...
    private boolean checkDupIdentity(MemberBean member, MvcReturnBean returnBean)
        throws MvcException
    {
        boolean success;
        Connection conn;
        ...
        try
        {
            ...
            if(formSubmitted)
            {
                ...
                if(register != null && register.length() > 0)
                    conditions = (new StringBuilder(String.valueOf(conditions))).append(" and mbr_register = '").append(register.trim()).append("' ").toString();
            ...
            returnBean.addReturnObject("RegisterType", getMapForRegisterType(true));
    ...
    public MemberBean[] getMemberList(SQLConditionsBean conditions)
        throws MvcException
    {
        MemberBean beans[];
        Connection conn;
        ...
        try
        {
            ...
            if(!list.isEmpty())
                beans = (MemberBean[])list.toArray(beans);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    public MemberBean[] searchMemberSelectionForStockist(String memberID, String name, String identityNo, String mobileNo, Date joinDateFrom, Date joinDateTo)
        throws Exception
    {
        MemberBean beans[];
        Connection conn;
        ...
        try
        {
            ...
            if(!list.isEmpty())
                beans = (MemberBean[])list.toArray(EMPTY_ARRAY_MEMBER);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    public MemberBean[] getMemberListByID(String memberID)
        throws MvcException
    {
        MemberBean beans[];
        Connection conn;
    ...
    public MemberBean getMemberByOriginalID(String originalID, boolean parseFullInfo)
        throws MvcException
    {
        return getMemberByOriginalID(originalID, null, parseFullInfo);
    }
    
    public MemberBean getMemberByOriginalID(String originalID, String branchID, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
        ...
        {
            conn = getConnection();
            member = getBroker(conn).getMemberByOriginalID(originalID, branchID, parseFullInfo);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    public MemberBean getMemberByIdCRM(String memberID, boolean parseFullInfo)
        throws MvcException
    {
        return getMemberByIdCRM(memberID, null, parseFullInfo);
    }
    
    public MemberBean getMemberByID(String memberID, boolean parseFullInfo)
        throws MvcException
    {
        return getMemberByID(memberID, null, parseFullInfo);
    }
        
    public MemberBean getMemberByID(String memberID, String branchID, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
    ...
    public MemberBean getMemberByIdCRM(String memberID, String branchID, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
        ...
        {
            conn = getConnection();
            member = getBroker(conn).getMemberByIdCRM(memberID, branchID, parseFullInfo);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    public MemberBean getMemberByMobile(String MobileNo, boolean parseFullInfo)
        throws MvcException
    {
        return getMemberByMobile(MobileNo, null, parseFullInfo);
    }

    public MemberBean getMemberByMobile(String MobileNo, String branchID, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
        ...
        {
            conn = getConnection();
            member = getBroker(conn).getMemberByMobile(MobileNo, branchID, parseFullInfo);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    public MemberBean getMemberBySeq(int memberSeq, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
    ...
    public MemberBean getMember(int memberSeq, String memberID, boolean parseFullInfo)
        throws MvcException
    {
        MemberBean member;
        Connection conn;
       ...
       boolean insert;
        ...
        try
        {
            ...
            if(insert)
            {
                ...
                // Sudah ditambah ke insertSponsorTree2
                // insertSponsorTree(member.getMemberID(), member.getIntroducerID());
                
                insertSponsorTree2(member.getMemberID(), member.getIntroducerID());
            } else
            {
                returnBean.fail();
            }
        ...
        throws MvcException
    {
        ...
        try
        {
            MemberBean newer = getMemberByID(owner.getMemberID(), true);
    ...
    private boolean changeIntroducer(MemberBean bean)
        throws Exception
    {
        boolean status;
        Connection conn;
    ...
    private boolean transferMembership(MemberBean owner, MemberBean newer)
        throws Exception
    {
        boolean status;
        Connection conn;
    ...
    private boolean addMemberBonusStatus(MemberBean member)
        throws MvcException
    {
        boolean status;
        Connection conn;
    ...
    private boolean updateMemberPaket1100(String paket)
        throws MvcException
    {
        boolean status;
        Connection conn;
        ...
        {
            conn = getConnection();
            status = getBroker(conn).updateMemberPaket1100(paket);
        }
        catch(Exception e)
        {
            Log.error(e);
    ...
    private boolean addMemberStartedPackBv(MemberBean member)
        throws MvcException
    {
        boolean status;
        Connection conn;
        ...
        try
        {
            ...
            // 27-10-2008 tambahan paket 1100 pv
            if (member.getRegister() == 2)
                bean.setBvIn(110D);
            else if (member.getRegister() == 6)
                bean.setBvIn(220D);            
            else                
                bean.setBvIn(0.0D);            
            ...
            if (member.getRegister() == 4 || member.getRegister() == 5)
                bean.setBvOut1(110D);
            else                
                bean.setBvOut1(0.0D);
    ...
    private boolean updateMember(MemberBean member)
        throws MvcException
    {
        boolean status;
        Connection conn;
    ...
    private boolean insertSponsorTree2(String memberID, String introducerID)
        throws MvcException
    {
        boolean status;
        Connection conn;
        ...
        try
        {
            ...
            // status = ntwkMgr.addSponsorTreeNode(memberID, introducerID);
            // coba New HIra
            status = ntwkMgr.addSponsorTreeNode2(memberID, introducerID);
        }
        catch(Exception e)
        {
            status = false;
    ...
    private boolean runMemberIDFactory(MvcReturnBean returnBean, MemberBean bean)
    {
        boolean status = false;
        try
        {
    ...
    private void checkBonusPeriodInfo(MemberBean bean, MvcReturnBean returnBean, HttpServletRequest request)
    {
        ...
        {
            // Sementara : returnBean.addError("Invalid Bonus Date Format");
        }
        ...
        try
        {
            ...
            case 202002: 
            {
                if(formSubmitted)
                {
                    ...
                    // maksud : jk taskId <> 0x19641 (Quiq Reg = 104001) mk registerStatus = 10, jk 104001 maka 0 
                    // System.out.println("registerStatus " + registerStatus);   
                    int registerStatus = (taskId == 0x19641 || taskId == 0x3151a ) ? 0 : 10;     
                    System.out.println("registerStatus " + registerStatus);
                ...
                if(returnBean == null)
                    returnBean = new MvcReturnBean();
                    returnBean.addReturnObject("OccupationType", getMapForOccupationType()); //Updated By Ferdi 2015-01-21
                    returnBean.addReturnObject("EthnicType", getMapForEthnicType()); //Updated By Ferdi 2015-01-23
                if(taskId == 0x19643 || taskId == 0x31512)
                {
                    ...
                    returnBean.addReturnObject("MobileNo", request.getParameter("MobileNo")); 
                    returnBean.addReturnObject("Gender", request.getParameter("Gender")); //Updated By Ferdi 2015-01-21
                    returnBean.addReturnObject("Salutation", request.getParameter("Salutation")); //Updated By Ferdi 2015-01-21
                    ...
                    returnBean.addReturnObject("OriginalID", request.getParameter("OriginalID"));
                    String noPin = request.getParameter("nopin");
                    if(noPin != null)
            ...
            case 300016: 
            {
                ...
                MemberBean bean = getMemberByID(memberID, true);
                if(bean != null)
                {
                    MemberBean intrBean = getMemberByID(bean.getIntroducerID(), true);
                    MemberBean placeBean = getMemberByID(bean.getPlacementID(), true);
            ...
            case 104036:    
            {
                ...
                if(bean == null && formSubmitted)
                    returnBean.addError("Record not found.");
                returnBean.addReturnObject("MemberBean", bean);
                returnBean.addReturnObject("OccupationType", getMapForOccupationType()); //Updated By Ferdi 2015-01-22
                returnBean.addReturnObject("EthnicType", getMapForEthnicType()); //Updated By Ferdi 2015-01-23
                break;
            }
            ...
            case 104043:
            {
                ...
                com.ecosmosis.orca.counter.sales.CounterSalesOrderBean bean = null;
                String salesID = request.getParameter("MemberID");
                System.out.println("Tangkap 0 getSalesID " + salesID); 
                
                if(salesID != null && salesID.trim().length() > 0)
                {
                    bean = getSalesOrder(salesID);                    
                    search = true;
                    System.out.println("Tangkap 1 getSalesID " + salesID);   
                }
                if(formSubmitted)
                {
                    System.out.println("Tangkap 2 getSalesID " + salesID); 
                 }
            ...
            {
                returnBean = new MvcReturnBean();
                MemberBean beans[] = EMPTY_ARRAY_MEMBER;
                Date joinDtFrom = null;
                Date joinDtTo = null;
                if(!formSubmitted)
                    break;
    ...
    private CounterSalesOrderBean getSalesOrder(String salesID) 
    throws MvcException
    {
        // String SalesID = null;
        ...
        try
        {
            System.out.println("Tangkap 3 getSalesID " + salesID); 
            conn = getConnection();
    ...
    private boolean changeLucky(CounterSalesOrderBean bean) {
        return false;
    }

    //Updated By Ferdi 2015-08-12
    public MemberBean[] getCustomerByID(String customerID)
        throws MvcException
    {
        MemberBean bean[] = new MemberBean[0];
        Connection conn;
        conn = null;
        ...
        {
            conn = getConnection();
            ArrayList list = getBroker(conn).getCustomerByID(customerID);
            
            if(!list.isEmpty())
            {
                bean = (MemberBean[])list.toArray(bean);
            }
        }
        catch(Exception e)
        {
